...
RUTA_ARCHIVO = r"opt/airflow/dags/data/facturas_repetidas_5.json"
...
def procesar_json():
    ...
    pandas_df.to_sql('facturas_5', engine, if_exists='append', index=False, chunksize=1000)
